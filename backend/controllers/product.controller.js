...
export const getFeaturedProducts = async ( req,res)=>{
    try{
        ...
        if(featuredProducts){
            return res.json(JSON.parse(featuredProducta));
        }
...
export const createProduct = async(req,res)=>{
    try{
        ...
        console.log("Error in crateProduct controller",error.message);
        res.status(500).json({message:"Server error",error:error.message});
    }
};
...
export const getProductsByCategory = async(req,res)=>{
    ...
    try{
        ...
        res.status(500).json({message:"Serer error",error:error.messgae});
...
async function updateFeaturedProductsCache(){
    try{
        ...
        console.log("Error in upadete cache function")
    }
}